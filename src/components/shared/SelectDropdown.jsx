...
const SelectDropdown = ({
 ...
 useEffect(() => {
    if (defaultSelect) {
        // Normalize defaultSelect into a string
        const normalizedDefault =
            typeof defaultSelect === "string"
                ? defaultSelect.toLowerCase()
                : defaultSelect?.value?.toLowerCase() ||
                  defaultSelect?.label?.toLowerCase() ||
                  "";

        const defaultOption = options?.find(
            (option) => option.value?.toLowerCase() === normalizedDefault
        );
