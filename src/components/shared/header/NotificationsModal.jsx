...
useEffect(() => {
  const fetchNotifications = async () => {
    ...
    const res = await axios.get("http://localhost:4500/notifications",config);
    ...
    <div className="dropdown nxl-h-item">
      ...
      <div className="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-notifications-menu">
        ...
        <div className="text-center notifications-footer">
          <Link to="#" className="fs-13 fw-semibold text-dark">
            Alls Notifications
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="notifications-item">
      ...
      <div className="notifications-desc">
        <Link to="#" className="font-body text-truncate-2-line">
          {" "}
