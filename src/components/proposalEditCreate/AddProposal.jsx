                        ...
                        <tr key={index}>
                          ...
                          <td>
                            <input
                              ...
                              Value={product}
                              onChange={(e)=>handleInputChange(id,"product",e.target.value)}
                            />
                          </td>
                          <td>
                            <input
            ...
            <div className="col-lg-4">
              ...
              <div className="table-responsive">
                <table className="table table-bordered" id="tab_logic_total">
                  <tbody>
                    <tr className="single-item">
                      <th className="fs-10 text-dark text-uppercase">
                        Sub Total
                      </th>
                      <td className="w-25">
                        <input
                    ...
                    <tr className="single-item">
                      <th className="fs-10 text-dark text-uppercase bg-gray-100">
                        Grand Total
                      </th>
